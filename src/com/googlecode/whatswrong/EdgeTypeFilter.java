...
/**
 * An EdgeTypeFilter filters out edges that do not have certain (prefix or
 * postfix) types.
 *
...
public class EdgeTypeFilter extends EdgeFilter {
  ...
  /**
   * Notifies every listener that the allow/disallow state of a type has
   * changed.
   *
  ...
  /**
   * Adds an allowed prefix type. This causes the filter to accept edges with
  ...
  /**
   * Disallows the given prefix type. This causes the filter to stop accepting
   * edges with the given prefix type.
   *
  ...
  /**
   * Disallows the given postfix type. This causes the filter to stop accepting
   * edges with the given postfix type.
   *
