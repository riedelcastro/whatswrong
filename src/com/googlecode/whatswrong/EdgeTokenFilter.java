 ...
 * com.googlecode.whatswrong.EdgeTokenFilter#addAllowedProperty(String)}) then the filter does
...
public class EdgeTokenFilter implements NLPInstanceFilter {
   ...
   *                          {@link com.googlecode.whatswrong.EdgeTokenFilter#isWholeWords()}
   *                          is false).
   */
   ...
   *                              if {@link com.googlecode.whatswrong.EdgeTokenFilter#isWholeWords()}
   *                              is false).
   */
