...
/**
 * A SimpleGridBagConstraints object is a GridBagConstraints object that can be
 * created using a set of convenience constructors. This allows us to create
 * constraints more easily and makes GridBagConstraint-based code more
 * readable.
 *
...
public class SimpleGridBagConstraints extends GridBagConstraints {
  ...
  /**
   * Creates a SimpleGridBagConstraints object with default properties and the
   * given gridx and gridy attributes.
   *
